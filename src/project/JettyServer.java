...
import project.handler.get.ProjectGetHandler;
        ...
        try
        {
            ...
            if ( service.equals(Service.PROJECT) )
            {
                ...
                if ( method.equals("GET") )
                    new ProjectGetHandler().handle( request, response, urn );
                else if ( method.equals("PUT") )
                    new ProjectPutHandler().handle( request, response, urn );
                else if ( method.equals("DELETE") )
                    new ProjectDeleteHandler().handle( request, response, urn );
                else if ( method.equals("POST") )
                    new ProjectPostHandler().handle( request, response, urn );
                else
                    throw new ProjectException("Unknown http method "+method);
            }
            else
                throw new ProjectException("Unknown service "+service);
        }
        catch ( ProjectException te )
        {
